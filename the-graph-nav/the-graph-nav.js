...
function renderViewRectangle(context, viewrect, props) {
  ...
  var x = Math.round(
    (props.viewrectangle[0] / props.scale - props.thumbrectangle[0]) *
      props.thumbscale
  );
  var y = Math.round(
    (props.viewrectangle[1] / props.scale - props.thumbrectangle[1]) *
      props.thumbscale
  );
...
function renderViewboxFromProps(context, viewbox, thumbInfo, props) {
  ...
  style.thumbscale = thumbW > thumbH
    ? props.width / thumbW
    : props.height / thumbH;
...
var Component = createReactClass({
  ...
  render: function() {
    ...
    return React.createElement(
      "div",
      { key: "nav", style: wrapperStyle, ref: this._refTopElement },
      [
  ...
  _renderElements: function() {
    ...
    renderViewboxFromProps(
      this._viewboxContext,
      this._viewboxElement,
      t,
      this.props
    );
  },
